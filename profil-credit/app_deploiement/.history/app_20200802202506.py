...
def predict():
    ...
    return render_template('index.html', prediction_text='La réponse à votre requête {}'.format(output)) #output présenté dans le texte est juste la sortie de la prédiction
